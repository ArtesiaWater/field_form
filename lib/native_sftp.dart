...
class NativeSftpConnection {
  NativeSftpConnection({
    required this.sessionId,
    required this.basePath,
  });

  static const MethodChannel _channel = MethodChannel('nl.artesia.field_form/native_sftp');

  final String sessionId;
  String basePath;

  static Future<NativeSftpConnection> connect({
    ...
    if (sessionId == null || sessionId.isEmpty) {
      throw Exception('Native SFTP connect returned no session id');
    }
    return NativeSftpConnection(sessionId: sessionId, basePath: path);
  }
